...
public class MaintainPersonImpl extends ServiceSupport implements MaintainPerson {
    ...
    public String[] getAspects(String operationName) {
        if ((ASPECTS == null)) {
            ...
            ASPECTS.put("maintainApplicant", new String[] { "org.nabucco.aspect.relating",
                    "org.nabucco.aspect.resolving", "org.nabucco.aspect.journaling", "org.nabucco.aspect.indexing",
                    "org.nabucco.aspect.transitioning" });
        }
