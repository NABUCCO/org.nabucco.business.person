...
/**
 * EmployeeSearchRq<p/>Search message for Employee<p/>
 *
 * @version 1.2
 * @author Dominic Trumpfheller, Holger Librenz, PRODYNA AG, 2011-07-19
 */
public class EmployeeSearchRq extends ServiceMessageSupport implements ServiceMessage {

    private static final long serialVersionUID = 1L;

    private static final Flag LOADABSENCE_DEFAULT = new Flag(false);
    ...
    public static final String LOADABSENCE = "loadAbsence";
    ...
    private Flag loadAbsence;

    /** Constructs a new EmployeeSearchRq instance. */
    public EmployeeSearchRq() {
        super();
        this.initDefaults();
    }
    ...
    private void initDefaults() {
        loadAbsence = LOADABSENCE_DEFAULT;
    }
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(LOADABSENCE,
                PropertyDescriptorSupport.createBasetype(LOADABSENCE, Flag.class, 8, PROPERTY_CONSTRAINTS[8], false));
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(ID), this.id));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(MASTERID), this.masterId));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(EMPLOYEEID), this.employeeId));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(BIRTHDAYFROM), this.birthdayFrom));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(BIRTHDAYTILL), this.birthdayTill));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(OWNER), this.owner));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(OWNERLIST), this.ownerList));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(USERIDLIST), this.userIdList));
        properties.add(super.createProperty(EmployeeSearchRq.getPropertyDescriptor(LOADABSENCE), this.loadAbsence));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(ID) && (property.getType() == Identifier.class))) {
            ...
            return true;
        } else if ((property.getName().equals(LOADABSENCE) && (property.getType() == Flag.class))) {
            this.setLoadAbsence(((Flag) property.getInstance()));
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final EmployeeSearchRq other = ((EmployeeSearchRq) obj);
        if ((this.id == null)) {
            if ((other.id != null))
                return false;
        ...
        if ((this.userIdList == null)) {
            ...
            return false;
        if ((this.loadAbsence == null)) {
            if ((other.loadAbsence != null))
                return false;
        } else if ((!this.loadAbsence.equals(other.loadAbsence)))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = ((PRIME * result) + ((this.loadAbsence == null) ? 0 : this.loadAbsence.hashCode()));
        return result;
    }
    ...
    /**
     * Missing description at method getLoadAbsence.
     *
     * @return the Flag.
     */
    public Flag getLoadAbsence() {
        return this.loadAbsence;
    }

    /**
     * Missing description at method setLoadAbsence.
     *
     * @param loadAbsence the Flag.
     */
    public void setLoadAbsence(Flag loadAbsence) {
        this.loadAbsence = loadAbsence;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(EmployeeSearchRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(EmployeeSearchRq.class).getAllProperties();
    }
}
