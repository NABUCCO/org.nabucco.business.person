...
public class ResolvePersonDelegate extends ServiceDelegateSupport {
     ...
     * @throws ClientException
     */
    public ApplicantListMsg resolveApplicantList(ApplicantListMsg message, ServiceSubContext... subContexts)
            throws ClientException {
        ServiceRequest<ApplicantListMsg> request = new ServiceRequest<ApplicantListMsg>(
                super.createServiceContext(subContexts));
        request.setRequestMessage(message);
        ...
        throw new ClientException("Cannot execute service operation: ResolvePerson.resolveApplicantList");
    }
