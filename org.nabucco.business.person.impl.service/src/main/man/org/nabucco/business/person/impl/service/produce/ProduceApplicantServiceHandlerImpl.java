...
/**
 * ProduceApplicantServiceHandlerImpl
 * 
 * @author Raffael Bieniek, PRODYNA AG
 */
public class ProduceApplicantServiceHandlerImpl extends ProduceApplicantServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected ApplicantListMsg produceApplicant(ApplicantProduceRq msg) throws ProduceException {
        ...
        for (int i = 0; i < msg.getNumber().getValue(); i++) {
            ...
            applicant.setDatatypeState(DatatypeState.INITIALIZED);
            applicant.setMaster(master);
