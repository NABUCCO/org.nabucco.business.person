...
/**
 * MaintainIndividualPersonServiceHandler<p/>Maintain Service for Person<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2010-11-30
 */
public abstract class MaintainIndividualPersonServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.business.person.impl.service.maintain.MaintainIndividualPersonServiceHandler";

    /** Constructs a new MaintainIndividualPersonServiceHandler instance. */
    public MaintainIndividualPersonServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<IndividualPersonMsg> invoke(ServiceRequest<IndividualPersonMsg> rq)
        ...
        try {
            ...
            msg = this.maintainIndividualPerson(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract IndividualPersonMsg maintainIndividualPerson(IndividualPersonMsg msg) throws MaintainException;
